/**
 * Aera Router Electron Desktop App - Preload Script
 *
...
const MAC_DRAG_STYLE_ID = "aera-router-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "aera-router-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__aeraRouterMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    style.textContent = `
      header,
      .aera-router-electron-drag-region {
        app-region: drag;
    ...
    dragRegion.className = "aera-router-electron-drag-region";
