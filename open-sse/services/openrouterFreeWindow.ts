 ...
 *
 * Bucketed by ACCOUNT, not by connection/key — multiple Aera Router connections
 * that share one upstream OpenRouter account must share one window. Aera Router's
