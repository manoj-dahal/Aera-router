 ...
 * Aera Router keeps the holdback OFF by default (see ResilienceSettings.streamRecovery)
...
// Terminal SSE markers Aera Router emits across formats: OpenAI `data: [DONE]`,
