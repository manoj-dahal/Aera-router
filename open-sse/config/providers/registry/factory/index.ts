...
// local `droid` CLI. Aera Router already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through Aera Router.
//
...
// back to stored CLI credentials only when omitted. Aera Router does NOT read
