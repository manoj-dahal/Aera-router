...
// upstream quota is per-account, and a single Aera Router provider entry maps to
// one user account. Multiple Aera Router connections under the same provider
