...
const PATCH_STATE_KEY = Symbol.for("aera-router.proxyFetch.state");
 ...
 *
 * This remains disabled unless AERA_ROUTER_CONTROL_PLANE_PROXY_DIRECT_FALLBACK is enabled
...
async function patchedFetch(
  ...
  if (
    ...
    if (process.env.AERA_ROUTER_PROXY_FETCH_DEBUG === "true") {
