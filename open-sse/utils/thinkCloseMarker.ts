 ...
 *
 * When Aera Router translates a Claude-native streamed response to OpenAI Chat
 ...
 * in explicitly with the request header `x-aera-router-thinking-marker: off`,
...
export const THINKING_MARKER_HEADER = "x-aera-router-thinking-marker";
...
/**
 * Interpret the explicit `x-aera-router-thinking-marker` request header.
 ...
 * this request. An explicit `x-aera-router-thinking-marker` header wins; absent
