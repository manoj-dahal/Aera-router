...
} from "@/domain/aeraRouterResponseMeta";
 ...
 *
 * Aera Router forwards upstream response headers verbatim. If we re-emit those
...
export function buildStreamingResponseHeaders(
  ...
  attachAeraRouterMetaHeaders(responseHeaders, meta);
