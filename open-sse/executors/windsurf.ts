 ...
 *
 * Aera Router → Windsurf model-ID mapping lives in MODEL_ID_MAP below.
 */
...
//
// This table handles only Aera-Router-style backwards-compat aliases where users
...
// Aera Router uses dot-notation user IDs (e.g. "gpt-5.5-high").
