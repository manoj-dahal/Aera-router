...
export class AntigravityExecutor extends BaseExecutor {
  ...
  async transformRequest(
    ...
    // Opt-in escape hatch: set AERA_ROUTERR_ALLOW_BODY_PROJECT_OVERRIDE=1.
    ...
    const allowBodyProjectOverride = process.env.AERA_ROUTER_ALLOW_BODY_PROJECT_OVERRIDE === "1";
    ...
    // Opt-in escape hatch: set AERA_ROUTER_ALLOW_BODY_PROJECT_OVERRIDE=1.
    let projectId =
