/**
 * Aera Router MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. aera_router_pool_status   — Get pool stats for one or all providers
 *   2. aera_router_pool_sessions — List per-session details for a provider's pool
 *   3. aera_router_pool_reset    — Shut down and recreate a pool
 *   4. aera_router_pool_warm     — Warm up a pool to a target session count
 *   5. aera_router_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  aera_router_pool_status: {
    name: "aera_router_pool_status",
    description:
  ...
  aera_router_pool_sessions: {
    name: "aera_router_pool_sessions",
    description:
  ...
  aera_router_pool_reset: {
    name: "aera_router_pool_reset",
    description:
  ...
  aera_router_pool_warm: {
    name: "aera_router_pool_warm",
    description:
  ...
  aera_router_pool_health: {
    name: "aera_router_pool_health",
    description:
  ...
  aera_router_browser_pool_status: {
    name: "aera_router_browser_pool_status",
    description:
