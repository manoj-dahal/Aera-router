/**
 * MCP Tool Schemas — Contracts for all 23 core and advanced Aera Router MCP tools.
 *
 ...
 *
 * Each tool wraps existing Aera Router API endpoints and exposes them through
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "aera_router_get_health",
  description:
    "Returns the current health status of Aera Router including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 2: aera_router_list_combos ---
...
// --- Tool 3: aera_router_get_combo_metrics ---
...
> = {
  name: "aera_router_get_combo_metrics",
  description:
...
// --- Tool 4: aera_router_switch_combo ---
...
// --- Tool 5: aera_router_check_quota ---
...
// --- Tool 6: aera_router_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through Aera Router's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 7: aera_router_cost_report ---
...
// --- Tool 8: aera_router_list_models_catalog ---
...
> = {
  name: "aera_router_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "aera_router_web_search",
  description:
    "Performs a web search using Aera Router's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "aera_router_web_fetch",
  description:
    "Fetches and extracts content from a URL using Aera Router's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 9: aera_router_simulate_route ---
...
// --- Tool 10: aera_router_set_budget_guard ---
...
> = {
  name: "aera_router_set_budget_guard",
  description:
...
// --- Tool 11: aera_router_set_routing_strategy ---
...
> = {
  name: "aera_router_set_routing_strategy",
  description:
...
// --- Tool 12: aera_router_set_resilience_profile ---
...
> = {
  name: "aera_router_set_resilience_profile",
  description:
...
// --- Tool 13: aera_router_test_combo ---
...
// --- Tool 14: aera_router_get_provider_metrics ---
...
> = {
  name: "aera_router_get_provider_metrics",
  description:
...
// --- Tool 15: aera_router_best_combo_for_task ---
...
> = {
  name: "aera_router_best_combo_for_task",
  description:
...
// --- Tool 16: aera_router_explain_route ---
...
// --- Tool 17: aera_router_get_session_snapshot ---
...
> = {
  name: "aera_router_get_session_snapshot",
  description:
...
// --- Tool 18: aera_router_db_health_check ---
...
> = {
  name: "aera_router_db_health_check",
  description:
    "Diagnoses Aera Router database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: aera_router_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "aera_router_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into Aera Router. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "aera_router_oneproxy_fetch",
  description:
...
> = {
  name: "aera_router_oneproxy_rotate",
  description:
...
> = {
  name: "aera_router_oneproxy_stats",
  description:
...
> = {
  name: "aera_router_agent_skills_list",
  description:
    "List Aera Router agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "aera_router_agent_skills_get",
  description:
...
> = {
  name: "aera_router_agent_skills_coverage",
  description:
