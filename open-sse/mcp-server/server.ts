...
const MCP_ENFORCE_SCOPES = process.env.AERA_ROUTER_MCP_ENFORCE_SCOPES === "true";
const MCP_ALLOWED_SCOPES = new Set(
  (process.env.AERA_ROUTER_MCP_SCOPES || "")
    .split(",")
    .map((s) => s.trim())
    .filter(Boolean)
);
...
export async function omniRouteFetch(path: string, options: RequestInit = {}): Promise<unknown> {
  ...
  if (!response.ok) {
    ...
    throw new Error(`Aera Router API error [${response.status}]: ${errorText}`);
  }
...
async function handleGetHealth() {
  ...
  try {
    ...
    await logToolCall("aera_router_get_health", {}, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_get_health", {}, null, Date.now() - start, false, msg);
...
async function handleListCombos(args: { includeMetrics?: boolean }) {
  ...
  try {
    ...
    await logToolCall("aera_router_list_combos", args, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_list_combos", args, null, Date.now() - start, false, msg);
    return { content: [{ type: "text" as const, text: `Error: ${msg}` }], isError: true };
  }
}
...
async function handleGetComboMetrics(args: { comboId: string }) {
  ...
  try {
    ...
    await logToolCall("aera_router_get_combo_metrics", args, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_get_combo_metrics", args, null, Date.now() - start, false, msg);
    return { content: [{ type: "text" as const, text: `Error: ${msg}` }], isError: true };
  }
}
...
async function handleSwitchCombo(args: { comboId: string; active: boolean }) {
  ...
  try {
    ...
    await logToolCall("aera_router_switch_combo", args, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_switch_combo", args, null, Date.now() - start, false, msg);
    return { content: [{ type: "text" as const, text: `Error: ${msg}` }], isError: true };
  }
}
...
async function handleCheckQuota(args: { provider?: string; connectionId?: string }) {
  ...
  try {
    ...
    await logToolCall("aera_router_check_quota", args, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_check_quota", args, null, Date.now() - start, false, msg);
    return { content: [{ type: "text" as const, text: `Error: ${msg}` }], isError: true };
  }
}
...
async function handleCostReport(args: { period?: string }) {
  ...
  try {
    ...
    await logToolCall("aera_router_cost_report", args, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_cost_report", args, null, Date.now() - start, false, msg);
    return { content: [{ type: "text" as const, text: `Error: ${msg}` }], isError: true };
  }
}
...
async function handleWebSearch(args: {
  ...
  try {
    ...
    await logToolCall("aera_router_web_search", args, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_web_search", args, null, Date.now() - start, false, msg);
    return { content: [{ type: "text" as const, text: `Error: ${msg}` }], isError: true };
  }
}
...
async function handleWebFetch(args: {
  ...
  try {
    ...
    await logToolCall("aera_router_web_fetch", args, result, Date.now() - start, true);
    return { content: [{ type: "text" as const, text: JSON.stringify(result, null, 2) }] };
  } catch (err) {
    const msg = err instanceof Error ? err.message : String(err);
    await logToolCall("aera_router_web_fetch", args, null, Date.now() - start, false, msg);
    return { content: [{ type: "text" as const, text: `Error: ${msg}` }], isError: true };
  }
}
...
export function createMcpServer(): McpServer {
  ...
  server.registerTool(
    ...
    {
      description:
        "Returns Aera Router health status including uptime, memory, circuit breakers, rate limits, and cache stats",
      inputSchema: getHealthInput,
    },
    withScopeEnforcement("aera_router_get_health", async (args) => {
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_list_combos", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_get_combo_metrics", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_switch_combo", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_check_quota", (args) =>
  ...
  server.registerTool(
    "aera_router_route_request",
    {
      description: "Sends a chat completion request through Aera Router intelligent routing",
      inputSchema: routeRequestInput,
    },
    withScopeEnforcement("aera_router_route_request", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_cost_report", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_list_models_catalog", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_simulate_route", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_set_budget_guard", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_set_routing_strategy", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_set_resilience_profile", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_test_combo", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_get_provider_metrics", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_best_combo_for_task", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_get_session_snapshot", async (args) => {
  ...
  server.registerTool(
    ...
    {
      description:
        "Diagnoses or repairs Aera Router database drift, including broken combo references and orphan quota/domain rows",
      inputSchema: dbHealthCheckInput,
    },
    withScopeEnforcement("aera_router_db_health_check", (args) =>
  ...
  server.registerTool(
    ...
    {
      description:
        "Syncs pricing data from external sources (LiteLLM) into Aera Router without overwriting user-set prices",
      inputSchema: syncPricingInput,
    },
    withScopeEnforcement("aera_router_sync_pricing", (args) =>
  ...
  server.registerTool(
    ...
    {
      description:
        "Performs a web search using Aera Router's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
      inputSchema: webSearchInput,
    },
    withScopeEnforcement("aera_router_web_search", (args) =>
      handleWebSearch(webSearchInput.parse(args))
    )
  );

  server.registerTool(
    "aera_router_web_fetch",
    {
      description:
        "Fetches and extracts content from a URL using Aera Router's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
      inputSchema: webFetchInput,
    },
    withScopeEnforcement("aera_router_web_fetch", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_cache_stats", () => handleCacheStats())
  );
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_cache_flush", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_oneproxy_fetch", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_oneproxy_rotate", (args) =>
  ...
  server.registerTool(
    ...
    withScopeEnforcement("aera_router_oneproxy_stats", (args) =>
 ...
 * Called when `aera-router --mcp` is used.
 */
export async function startMcpStdio(): Promise<void> {
  ...
  console.error("[MCP] Aera Router MCP Server starting (stdio transport)...");
  try {
    await server.connect(transport);
    console.error("[MCP] Aera Router MCP Server connected and ready.");
  } finally {
    if (closeAuditDb()) {
