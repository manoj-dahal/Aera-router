...
/**
 * Shared repair action used by both `aera-router runtime repair` and the
 * top-level `aera-router repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `aera-router repair` invokes the SAME action
  // as `aera-router runtime repair` (no duplicated logic). Surfaced in the
