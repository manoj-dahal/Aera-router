...
import { checkRequestIP } from "@aera-router/open-sse/services/ipFilter.ts";
  ...
  const response = NextResponse.json(
    {
      error: {
        ...
        message:
          ...
          "Refresh the dashboard and retry, or set AERA_ROUTER_PUBLIC_BASE_URL for non-dashboard browser integrations.",
        correlation_id: requestId,
      },
    },
    { status: 403 }
