...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-aera-router-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-aera-router-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-aera-router-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-aera-router-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-aera-router-auth-scopes";
 ...
 * token matches this process's AERA_ROUTER_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-aera-router-peer-ip";
 ...
 * proxy hop (e.g. Aera Router behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-aera-router-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-aera-router-peer-locality";
