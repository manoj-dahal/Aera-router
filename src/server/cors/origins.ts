 ...
 *
 * Source of truth for which browser origins may call Aera Router over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-aera-router-connection, x-internal-test, accept";
