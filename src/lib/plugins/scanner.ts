 ...
 *
 * Scans ~/.aera-router/plugins/ for subdirectories containing plugin.json manifests.
...
/**
 * Get the default plugin directory: ~/.aera-router/plugins/
 */
export function getDefaultPluginDir(): string {
  const home = process.env.HOME || process.env.USERPROFILE || "/tmp";
  return join(home, ".aera-router", "plugins");
}
