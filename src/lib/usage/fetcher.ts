...
} from "@aera-router/open-sse/config/providerHeaderProfiles.ts";
import { applyAntigravityClientProfileHeaders } from "@aera-router/open-sse/services/antigravityClientProfile.ts";
import { getAntigravityHeaders } from "@aera-router/open-sse/services/antigravityHeaders.ts";
import {
  getAntigravityFetchAvailableModelsUrls,
  ANTIGRAVITY_BASE_URLS,
} from "@aera-router/open-sse/config/antigravityUpstream.ts";
import {
  getAntigravityRemainingCredits,
  updateAntigravityRemainingCredits,
} from "@aera-router/open-sse/executors/antigravity.ts";
import { getCreditsMode } from "@aera-router/open-sse/services/antigravityCredits.ts";
import {
  generateAntigravityRequestId,
  getAntigravitySessionId,
} from "@aera-router/open-sse/services/antigravityIdentity.ts";
 ...
 * Real Claude OAuth quota windows are fetched in @aera-router/open-sse/services/usage.ts.
 */
