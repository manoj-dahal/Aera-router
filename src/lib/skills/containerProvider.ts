/**
 * Container runtime providers for the Aera Router skill sandbox.
 *
 * The sandbox historically hardcoded the `docker` CLI. This module abstracts
 * the container runtime so Aera Router can pick the most performant / native
...
const SANDBOX_NAME = (sandboxId: string) => `aera-router-${sandboxId}`;
