 ...
 *     is set explicitly. The Aera Router LOCAL_ONLY rule is enforced at the
...
declare global {
  var __aeraRouterEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__aeraRouterEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__aeraRouterEmbedWsStarted = true;
