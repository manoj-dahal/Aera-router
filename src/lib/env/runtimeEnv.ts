...
export const webRuntimeEnvSchema = z.object({
  ...
  AERA_ROUTER_DISABLE_BACKGROUND_SERVICES: optionalBooleanEnv,
  CLOUD_URL: optionalHttpUrl,
  NEXT_PUBLIC_CLOUD_URL: optionalHttpUrl,
  AERA_ROUTER_PUBLIC_BASE_URL: optionalHttpUrl,
  AERA_ROUTER_BASE_URL: optionalHttpUrl,
  BASE_URL: optionalHttpUrl,
  NEXT_PUBLIC_BASE_URL: optionalHttpUrl,
  AERA_ROUTER_PORT: optionalPortEnv,
