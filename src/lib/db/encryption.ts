 ...
 * The PRIMARY key is now derived with a static salt ("aera-router-field-encryption-v1").
 ...
 * a different derived key than the static salt `"aera-router-field-encryption-v1"`. When the
