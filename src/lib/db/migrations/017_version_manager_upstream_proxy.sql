...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'aera-router'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with Aera Router
...
-- Determines whether each provider uses Aera Router's native executor,
