...
function isAutoSyncEnabled() {
  // Opt-in, default OFF. Backed by the AERA_ROUTER_AUTO_SYNC_CODEX_PROFILES feature flag
  ...
  return isFeatureFlagEnabled("AERA_ROUTER_AUTO_SYNC_CODEX_PROFILES");
}
...
export async function autoSyncCodexProfilesFromLiveCatalog(
  ...
  // Reuse the CLI generator so automatic sync and `aera-router setup-codex`
