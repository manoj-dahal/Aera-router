 ...
 * trace out of Aera Router into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The Aera Router capture source
...
const CREATOR_NAME = "Aera Router Traffic Inspector";
