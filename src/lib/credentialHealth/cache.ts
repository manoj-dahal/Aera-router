...
declare global {
  var __aeraRouterCredentialCache:
    | {
        initialized: boolean;
...
function getCacheState() {
  if (!globalThis.__aeraRouterCredentialCache) {
    globalThis.__aeraRouterCredentialCache = {
      initialized: false,
      cache: new Map(),
    };
  }
  return globalThis.__aeraRouterCredentialCache;
}
