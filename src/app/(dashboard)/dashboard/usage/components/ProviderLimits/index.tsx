...
const LS_PURCHASE_FILTER = "aera-router:limits:purchaseFilter";
const LS_STATUS_FILTER = "aera-router:limits:statusFilter";
const LS_ENV_FILTER = "aera-router:limits:envFilter";
const LS_PROVIDER_FILTER = "aera-router:limits:providerFilter";
