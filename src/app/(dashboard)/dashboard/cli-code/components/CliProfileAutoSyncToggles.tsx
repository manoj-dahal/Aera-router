...
const CODEX_KEY = "AERA_ROUTER_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "AERA_ROUTER_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the AERA_ROUTER_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
