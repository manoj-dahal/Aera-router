 ...
 *
 * Serves the Aera Router A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the Aera Router Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "Aera Router AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 Aera Router agent skills (22 API + 20 CLI) " +
