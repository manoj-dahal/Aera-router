...
import {
  VALID_VARIANTS,
  type AutoVariant,
} from "@aera-router/open-sse/services/autoCombo/autoPrefix";
import {
  AUTO_SUFFIX_VARIANTS,
  AUTO_TEMPLATE_VARIANTS,
  AUTO_FAMILY_IDS,
} from "@aera-router/open-sse/services/autoCombo/builtinCatalog";
import { parseAutoSuffix } from "@aera-router/open-sse/services/autoCombo/suffixComposition";
...
export async function GET(request: Request) {
  ...
  try {
    const { createVirtualAutoCombo } =
      await import("@aera-router/open-sse/services/autoCombo/virtualFactory");
