...
} from "@aera-router/open-sse/handlers/imageGeneration.ts";
import { withInjectionGuard } from "@/middleware/promptInjectionGuard";
import {
  getProviderCredentialsWithQuotaPreflight,
  clearRecoveredProviderState,
} from "@/sse/services/auth";
import { parseImageModel, getImageProvider } from "@aera-router/open-sse/config/imageRegistry.ts";
 ...
 *    generated through Aera Router — we then have its `{conversationId, parentMessageId}`
