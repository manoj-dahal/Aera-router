...
import { handleAudioTranscription } from "@aera-router/open-sse/handlers/audioTranscription.ts";
import {
...
import { attachAeraRouterMetaToResponse } from "@/domain/aeraRouterResponseMeta";
...
export async function POST(request) {
  ...
  if (response?.ok) {
    ...
    response = attachAeraRouterMetaToResponse(response, {
      provider,
      model: resolvedModel,
      costUsd: 0,
