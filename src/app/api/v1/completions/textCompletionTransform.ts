/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. Aera Router routes
 ...
 * the model they asked for, and the `x-aera-router-model` response header
 ...
 * requested identifier (matching the `x-aera-router-model` response header).
 */
