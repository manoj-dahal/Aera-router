import { handleVideoGeneration } from "@aera-router/open-sse/handlers/videoGeneration.ts";
import { resolveVideoCredentialProvider } from "@aera-router/open-sse/handlers/videoGeneration/googleFlow.ts";
import { withInjectionGuard } from "@/middleware/promptInjectionGuard";
import {
  getProviderCredentialsWithQuotaPreflight,
  clearRecoveredProviderState,
} from "@/sse/services/auth";
import { parseVideoModel, getVideoProvider } from "@aera-router/open-sse/config/videoRegistry.ts";
