...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      ...runtime,
      settings,
      hasAeraRouter: hasAeraRouterQwenCodeConfig(settings),
...
export async function POST(request: Request): Promise<Response> {
  ...
  try {
    ...
    if (!apiKey) apiKey = "sk_aera_router";
    ...
    return NextResponse.json({
      success: true,
      message: "Qwen Code now routes through Aera Router",
      settingsPath: configPaths.settings,
      envPath: configPaths.env,
    });
  } catch (error) {
...
export async function DELETE(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Aera Router settings removed from Qwen Code",
    });
  } catch (error) {
