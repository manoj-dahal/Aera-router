...
// Check if Aera Router is configured as OpenAI-compatible provider
const hasAeraRouterConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasAeraRouter: hasAeraRouterConfig(globalState),
...
// POST - Configure Cline to use Aera Router as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_aera_router";
...
// DELETE - Remove Aera Router OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Aera Router settings removed from Cline",
    });
  } catch (error) {
