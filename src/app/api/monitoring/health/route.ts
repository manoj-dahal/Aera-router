...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@aera-router/open-sse/services/rateLimitManager"),
      import("@aera-router/open-sse/services/accountFallback"),
      import("@aera-router/open-sse/services/requestDedup.ts"),
      import("@aera-router/open-sse/services/quotaMonitor.ts"),
      import("@aera-router/open-sse/services/sessionManager.ts"),
