/**
 * Global Type Declarations for Aera Router
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    AERA_ROUTER_PUBLIC_BASE_URL?: string;
    AERA_ROUTER_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    AERA_ROUTER_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    AERA_ROUTER_BASE_URL?: string;
    AERA_ROUTER_DISABLE_BACKGROUND_SERVICES?: string;
    AERA_ROUTER_PORT?: string;
