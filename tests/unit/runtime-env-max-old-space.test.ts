 ...
 * AERA_ROUTER_MEMORY_MB instead of relying only on the image-level NODE_OPTIONS
 ...
 * uses (mirroring `aera-router serve`): AERA_ROUTER_MEMORY_MB clamped to [64, 16384],
 * default 512.
 */
...
test("#2939 honors a valid AERA_ROUTER_MEMORY_MB (string or number)", () => {
