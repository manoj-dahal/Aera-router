 ...
 * spawned with a FIXED 512MB heap default (`aera-router serve`) or with no
 ...
 * ceiling scales with the machine. An explicit `AERA_ROUTER_MEMORY_MB` still wins
...
test("#5172 an explicit AERA_ROUTER_MEMORY_MB still wins over the calibrated default", () => {
