 ...
 *
 * Aera Router's runtime Docker image (`Dockerfile`) runs as `USER node` (UID 1000)
 ...
 *
 * This mirrors upstream behavior (decolua/9router) extended to Aera Router's TS
 * fork and Aera Router's existing root-detection (`isRoot()`).
 */
