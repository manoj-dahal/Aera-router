...
import { detectCompressionLanguage } from "@aera-router/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@aera-router/open-sse/services/compression/caveman.ts";
