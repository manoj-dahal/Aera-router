...
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "aera-router-embeddings-gemini-dim-"));
...
// so Aera Router must forward `outputDimensionality` alongside `dimensions` for Gemini
