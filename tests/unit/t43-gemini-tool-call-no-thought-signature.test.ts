 ...
 *
 * After the fix for issue #1410, Aera Router no longer injects a hardcoded
 ...
 *
 * Reproduces: https://github.com/manoj-dahal/Aera-router/issues/1410
 * Supersedes: https://github.com/manoj-dahal/Aera-router/issues/725
 */
