...
function makeSkill(overrides: Partial<AgentSkill> = {}): AgentSkill {
  return {
    ...
    rawUrl:
      "https://raw.githubusercontent.com/manoj-dahal/Aera-router/refs/heads/main/skills/omni-providers/SKILL.md",
    githubUrl:
      "https://github.com/manoj-dahal/Aera-router/blob/main/skills/omni-providers/SKILL.md",
    ...overrides,
  };
}
