...
// Regression guard for #3883: the @aera-router/opencode-plugin must ship an
...
const PKG_URL = new URL("../../../@aera-router/opencode-plugin/package.json", import.meta.url);
const TSUP_URL = new URL("../../../@aera-router/opencode-plugin/tsup.config.ts", import.meta.url);
