...
import { normalizeClaudeHaikuConstraints } from "@aera-router/open-sse/services/claudeHaikuConstraints.ts";
...
// Several Aera Router paths can still emit these on Haiku targets:
