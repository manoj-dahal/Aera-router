...
test("setupPolyfill.ts is allowed in the tarball (bin/aera-router.mjs imports it at startup)", () => {
...
test("findMissingArtifactPaths flags missing root runtime files in the tarball", () => {
  ...
  // above (dist/server.js, bin/aera-router.mjs, package.json, the postinstall scripts).
