...
import { REGISTRY } from "@aera-router/open-sse/config/providers/index.ts";
import { FREE_MODEL_BUDGETS } from "@aera-router/open-sse/config/freeModelCatalog.data.ts";
...
// fabricated (copied from Aera Router's own Anthropic catalog) and live-verified
