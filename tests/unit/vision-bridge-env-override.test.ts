 ...
 *     Aera Router self-loop, Google's Gemini OpenAI-compat endpoint).
...
test("#2232 — Aera-Router-internal providers default to self-loop when no env vars set", () => {
  clearEnv();
  // Non-standard prefixes (kr/, if/, pol/, groq/) should use Aera Router self-loop
