...
description: Synchronise Aera Router configuration, provider connections, and settings to/from cloud storage. Manage cloud worker authentication and remote backup targets.
---
...
Authenticates with the Aera Router cloud worker for remote access.
