...
Issue: `https://github.com/manoj-dahal/Aera-router/issues/5980`
PR: `https://github.com/manoj-dahal/Aera-router/pull/7002`

## Goal

Deliver GitHub issue #5980 as a production issue-agent workflow. The workflow
must execute recorded GitHub triage through Aera Router routing, persist a complete
...
| DEC-002     | Keep issue-agent execution opt-in with `AERA_ROUTER_ISSUE_AGENT_ENABLED=true`    | prevents unrequested autonomous execution                                                                      | `implemented` |
