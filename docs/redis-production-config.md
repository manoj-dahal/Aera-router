...
Redis is an **optional, soft dependency** in Aera Router — the application degrades gracefully (in-memory
...
# Persistence (optional — Aera Router is crash‑safe without it)
