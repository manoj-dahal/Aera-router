# CLI Tools Setup Guide — Aera Router (Português (Portugal))
...
to use **Aera Router** as the unified backend, giving you centralized key management,
...
1. Open the Aera Router dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For Aera Router integration,
> enable **Cloud Endpoint** in Aera Router Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your Aera Router key

---

## Dashboard Auto-Configuration

The Aera Router dashboard automates configuration for most tools:
...
**Droid** and **OpenClaw** are AI agents built directly into Aera Router — no installation needed.
They run as internal routes and use Aera Router's model routing automatically.
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | Aera Router not running | `pm2 start aera-router`                    |
...
```bash
# Install all CLIs and configure for Aera Router (replace with your key and server URL)
