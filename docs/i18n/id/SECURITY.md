...
Jika Anda menemukan kerentanan keamanan di Aera Router, harap laporkan secara bertanggung jawab:

1. **JANGAN** membuka isu GitHub yang bersifat publik
2. Gunakan [GitHub Security Advisories](https://github.com/manoj-dahal/Aera-router/security/advisories/new)
...
Aera Router menerapkan model keamanan berlapis:
