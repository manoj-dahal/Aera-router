# 🚀 Aera Router — Gateway AI Gratis (Bahasa Indonesia)
...
![NPM Downloads](https://img.shields.io/npm/dw/aera-router?label=npm%20down%20week&color=red)
![NPM Downloads](https://img.shields.io/npm/dm/aera-router?label=npm%20down%20month&color=red)

![NPM Downloads](https://img.shields.io/npm/d18m/aera-router?label=npm%20down%20year&color=red)
![Docker Pulls](https://img.shields.io/docker/pulls/diegosouzapw/aera-router)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/diegosouzapw/aera-router/total?style=flat&label=eletron%20donwloads&color=blue)

[![stars](https://custom-icon-badges.demolab.com/github/stars/manoj-dahal/Aera-router?logo=star&style=flat)](https://github.com/manoj-dahal/Aera-router/stargazers)
[![open issues](https://custom-icon-badges.demolab.com/github/issues-raw/manoj-dahal/Aera-router?logo=issue)](https://github.com/manoj-dahal/Aera-router/issues)
[![license](https://custom-icon-badges.demolab.com/github/license/manoj-dahal/Aera-router?logo=law)](https://github.com/manoj-dahal/Aera-router/blob/main/LICENSE)
[![last commit](https://custom-icon-badges.demolab.com/github/last-commit/manoj-dahal/Aera-router?logo=history&logoColor=white)](https://github.com/manoj-dahal/Aera-router/commits/main)
...
[![code size](https://custom-icon-badges.demolab.com/github/languages/code-size/manoj-dahal/Aera-router?logo=file-code&logoColor=white)](https://github.com/manoj-dahal/Aera-router)
[![pr closed](https://custom-icon-badges.demolab.com/github/issues-pr-closed/manoj-dahal/Aera-router?color=purple&logo=git-pull-request&logoColor=white)](https://github.com/manoj-dahal/Aera-router/pulls?q=is%3Apr+is%3Aclosed)
[![tag](https://custom-icon-badges.demolab.com/github/v/tag/manoj-dahal/Aera-router?logo=tag&logoColor=white)](https://github.com/manoj-dahal/Aera-router/tags)
...
[![fork](https://custom-icon-badges.demolab.com/github/forks/manoj-dahal/Aera-router?logo=fork)](https://github.com/manoj-dahal/Aera-router/network/members)
[![watch](https://custom-icon-badges.demolab.com/github/watchers/manoj-dahal/Aera-router?logo=eye)](https://github.com/manoj-dahal/Aera-router/watchers)

[![License](https://img.shields.io/github/license/manoj-dahal/Aera-router)](https://github.com/manoj-dahal/Aera-router/blob/main/LICENSE)
...
[🌐 Website](https://aera-router.online) • [🚀 Mulai Cepat](#-quick-start) • [💡 Fitur](#-key-features) • [📖 Dokumentasi](#-documentation) • [💰 Harga](#-pricing-at-a-glance) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)
...
<div align="center">
  <img src="./docs/screenshots/MainAeraRouter.png" alt="Aera Router Dashboard" width="800"/>
</div>
...
_Hubungkan IDE atau alat CLI berbasis AI apa pun melalui Aera Router — gateway API gratis untuk coding tanpa batas._
...
<sub>📡 Semua agen terhubung melalui <code>http://localhost:20128/v1</code> atau <code>http://cloud.aera-router.online/v1</code> — satu konfigurasi, model dan kuota tak terbatas</sub>
...
- **Website**: [aera-router.online](https://aera-router.online)
- **GitHub**: [github.com/manoj-dahal/Aera-router](https://github.com/manoj-dahal/Aera-router)
- **Issues**: [github.com/manoj-dahal/Aera-router/issues](https://github.com/manoj-dahal/Aera-router/issues)
...
## 🎯 Apa yang Diselesaikan Aera Router — 30 Masalah Nyata & Kasus Penggunaan

> **Setiap developer yang menggunakan alat AI menghadapi masalah ini setiap hari.** Aera Router dibangun untuk menyelesaikannya semua — dari pembengkakan biaya hingga pemblokiran regional, dari alur OAuth yang rusak hingga operasi protokol dan observabilitas enterprise.
...
**Cara Aera Router menyelesaikannya:**
...
**Bagaimana Aera Router menyelesaikannya:**
...
- **Laporan Info Sistem** — `npm run system-info` menghasilkan `system-info.txt` dengan lingkungan lengkap Anda (versi Node, versi Aera Router, OS, alat CLI, status Docker/PM2). Lampirkan saat melaporkan masalah untuk triase instan.
...
- **instal global npm** — `npm install -g aera-router && aera-router` — selesai
...
- Mulai cepat bawaan untuk `aera-router --mcp` dan orientasi klien
...
```txt
1) Start MCP transport (`aera-router --mcp`) for tool-driven operations
...
>
> ```bash
> pnpm add -g aera-router@latest --allow-build=better-sqlite3 --allow-build=@swc/core
> aera-router
> ```
...
Pengguna Arch Linux dapat menginstal [AUR package](https://aur.archlinux.org/packages/aera-router-bin), yang menginstal Aera Router dan menyediakan layanan pengguna systemd:

```bash
yay -S aera-router-bin
systemctl --user enable --now aera-router.service
```

| Command                   | Description                                                     |
| ------------------------- | --------------------------------------------------------------- |
| `aera-router`             | Mulai server (`PORT=20128`, API dan dasbor pada port yang sama) |
| `aera-router --port 3000` | Set canonical/API port to 3000                                  |
| `aera-router --mcp`       | Mulai server MCP (stdio transport)                              |
| `aera-router --no-open`   | Don't auto-open browser                                         |
| `aera-router --help`      | Show help                                                       |

Optional split-port mode:

```bash
PORT=20128 DASHBOARD_PORT=20129 aera-router
...
| Command                  | Action                                                                                       |
| ------------------------ | -------------------------------------------------------------------------------------------- |
| `npm run uninstall`      | Menghapus aplikasi sistem tetapi **menyimpan DB dan konfigurasi Anda** di `~/.aera-router`.  |
| `npm run uninstall:full` | Menghapus aplikasi DAN secara permanen **menghapus semua konfigurasi, kunci, dan database**. |

> Catatan: Untuk menjalankan perintah ini, navigasikan ke folder proyek Aera Router (jika Anda mengkloningnya) dan jalankan. Alternatifnya, jika diinstal secara global, Anda cukup menjalankan `npm uninstall -g aera-router`.
...
| `STREAM_IDLE_TIMEOUT_MS` | inherits `REQUEST_TIMEOUT_MS` | Kesenjangan maksimum antara potongan streaming sebelum Aera Router membatalkan aliran SSE                                                                                    |
...
Untuk upstream yang kompatibel dengan Kode Claude (`anthropic-compatible-cc-*`), Aera Router juga memperoleh header `X-Stainless-Timeout` keluar dari batas waktu pengambilan yang diselesaikan sehingga batas waktu baca sisi penyedia tetap selaras dengan konfigurasi env Anda.

Untuk reverse proxy pihak ketiga yang kompatibel dengan Claude Code, Aera Router tetap menggunakan default
...
`cache_control`, Aera Router tidak memasukkan penanda milik jembatan.
...
Untuk permintaan streaming, `FETCH_TIMEOUT_MS` hanya mencakup pengaturan koneksi/menunggu respons upstream pertama. Setelah aliran aktif, Aera Router hanya akan dibatalkan pada keadaan terhenti sebenarnya (`STREAM_IDLE_TIMEOUT_MS`) atau tubuh Undici tidak aktif (`FETCH_BODY_TIMEOUT_MS`).

Jika Anda menjalankan Aera Router di belakang Nginx, Caddy, Cloudflare, atau proksi terbalik lainnya, pastikan proksi tersebut
waktu tunggu juga lebih tinggi daripada waktu tunggu aliran/pengambilan Aera Router Anda.
...
### 3) Arahkan alat pengkodean Anda ke Aera Router
...
Untuk pengguna Void Linux, Anda dapat membuat paket asli menggunakan `xbps-src`. Simpan blok ini sebagai `srcpkgs/aera-router/template`:
...
Aera Router tersedia sebagai image Docker publik di [Docker Hub](https://hub.docker.com/r/diegosouzapw/aera-router).
...
- Terowongan Cepat tidak dipulihkan secara otomatis setelah Aera Router atau kontainer dimulai ulang. Aktifkan kembali dari dasbor bila diperlukan.
...
- SQLite berjalan dalam mode WAL. `docker stop` harus dibiarkan selesai sehingga Aera Router dapat memeriksa kembali perubahan terbaru ke `storage.sqlite`.
...
- Setel `CLOUDFLARED_BIN=/absolute/path/to/cloudflared` jika Anda ingin Aera Router menggunakan biner yang sudah ada alih-alih mengunduhnya.

**Menggunakan Docker Compose dengan Caddy (HTTPS Auto-TLS):**

Aera Router dapat diekspos dengan aman menggunakan penyediaan SSL otomatis Caddy. Pastikan data DNS A domain Anda mengarah ke IP server Anda.

```yaml
services:
  aera-router:
    image: diegosouzapw/aera-router:latest
    container_name: aera-router
    restart: unless-stopped
    volumes:
      - aera-router-data:/app/data
    environment:
      - PORT=20128
  ...
  caddy:
    ...
    ports:
      - "80:80"
      - "443:443"
    command: caddy reverse-proxy --from https://your-domain.com --to http://aera-router:20128
...
| -------------------------- | -------- | ------ | --------------------- |
| `diegosouzapw/aera-router` | `latest` | ~250MB | Latest stable release |
| `diegosouzapw/aera-router` | `3.6.2`  | ~250MB | Current version       |

---

## 🖥️ Aplikasi Desktop — Offline & Selalu Aktif

> 🆕 **BARU!** Aera Router kini tersedia sebagai **aplikasi desktop asli** untuk Windows, macOS, dan Linux.

Jalankan Aera Router sebagai aplikasi desktop mandiri — tanpa terminal, tanpa browser, tanpa internet untuk model lokal. Aplikasi berbasis Electron meliputi:

- 🖥️ **Jendela Asli** — Jendela aplikasi khusus dengan integrasi baki sistem
- 🔄 **Mulai Otomatis** — Luncurkan Aera Router saat login sistem
...
Saat diminimalkan, Aera Router ada di baki sistem Anda dengan tindakan cepat:
...
**Tanpa biaya. Jangan pernah berhenti melakukan pengkodean.** Konfigurasikan ini sebagai satu kombo Aera Router dan semua fallback terjadi secara otomatis — tidak pernah ada peralihan manual.
...
> Semua model di bawah **100% gratis tanpa memerlukan kartu kredit**. Aera Router melakukan rute otomatis di antara keduanya ketika satu kuota habis — gabungkan semuanya untuk kombo $0 yang tidak dapat dipecahkan.
...
Aera Router v3.6 dibangun sebagai platform operasional, bukan hanya proxy relai.
...
Ketika kuota, tarif, atau kesehatan gagal, Aera Router secara otomatis berpindah ke kandidat berikutnya tanpa peralihan manual.
...
Aera Router menyertakan kerangka evaluasi bawaan untuk menguji kualitas respons LLM terhadap rangkaian emas. Akses melalui **Analytics → Evals** di dasbor.

### Golden Set Bawaan

"Aera Router Golden Set" yang dimuat sebelumnya berisi kasus uji untuk:
...
2. Jalankan `aera_router_get_health`.
3. Jalankan `aera_router_list_combos`.
...
**Kiat Pro:** Gunakan Opus untuk tugas kompleks, Soneta untuk kecepatan. Aera Router melacak kuota per model!
...
- Perilaku rotasi: Aera Router merutekan ke akun Codex berikutnya yang memenuhi syarat secara otomatis.
...
**Kiat Pro:** API yang kompatibel dengan OpenAI — bekerja secara lancar dengan terjemahan format Aera Router!
...
> **Catatan:** OpenClaw hanya berfungsi dengan Aera Router lokal. Gunakan `127.0.0.1` alih-alih `localhost` untuk menghindari masalah resolusi IPv6.
...
Settings → API Configuration:
  ...
  Base URL: http://localhost:20128/v1
  API Key: [from Aera Router dashboard]
  Model: if/kimi-k2-thinking
```

### OpenCode

**Langkah 1:** Tambahkan Aera Router sebagai penyedia khusus:

```bash
opencode
/connect
# Select "Other" → Enter ID: "aera-router" → Enter your Aera Router API key
```
...
```bash
/models
# Select any Aera Router model from the list
```

> **Tips:** Tambahkan model apa pun yang tersedia di titik akhir Aera Router `/v1/models` Anda ke bagian `models`. Gunakan format `provider/model-id` dari dasbor Aera Router Anda.
...
- Disegarkan secara otomatis oleh Aera Router
...
- Aera Router v1.0.6+ menyertakan validasi fallback melalui penyelesaian obrolan
...
> **⚠️ Penting bagi pengguna yang menjalankan Aera Router di VPS, Docker, atau server jarak jauh mana pun**

Kredensial OAuth yang disertakan dalam Aera Router didaftarkan **hanya untuk `localhost`**. Saat Anda mengakses Aera Router di server jarak jauh (misalnya `https://aera-router.myserver.com`), Google menolak autentikasi dengan:
...
- Nama: apa pun yang Anda suka (mis. `Aera Router Remote`)
...
1. Aera Router membuka URL otorisasi Google
...
4. Tempelkan URL tersebut ke bidang yang ditampilkan di modal koneksi Aera Router
5. Klik **"Hubungkan"**
...
- **Situs Web**: [aera-router.online](https://aera-router.online)
- **Paket**: [npmjs.com/package/aera-router](https://www.npmjs.com/package/aera-router)
- **Pekerja Pelabuhan**: [hub.docker.com/r/diegosouzapw/aera-router](https://hub.docker.com/r/diegosouzapw/aera-router)
...
Aera Router memiliki **218+ fitur yang direncanakan** di berbagai fase pengembangan. Berikut adalah bidang-bidang utamanya:
...
[![Contributors](https://contrib.rocks/image?repo=manoj-dahal/Aera-router&max=100&columns=20&anon=1)](https://github.com/manoj-dahal/Aera-router/graphs/contributors)
...
<a href="https://www.star-history.com/?repos=diegosouzapw%2Faera_router&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/aera-router&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=diegosouzapw/aera-router&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=diegosouzapw/aera-router&type=date&legend=top-left" />
 </picture>
</a>
...
<div align="center">
  ...
  <br/>
  <sub><a href="https://aera-router.online">aera-router.online</a></sub>
</div>
