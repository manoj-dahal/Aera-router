...
- sebelum akun aktif habis, Aera Router menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, Aera Router menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, Aera Router menghasilkan ringkasan handoff
...
Aera Router menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, Aera Router mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
