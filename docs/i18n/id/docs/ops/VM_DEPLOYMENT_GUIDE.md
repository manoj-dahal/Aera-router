# Aera Router — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi Aera Router pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout Aera Router Anda. Jika Anda menaikkan
...
Lihat dokumentasi lengkap di [aeraRouterCloud/README.md](../aeraRouterCloud/README.md).
...
| 20128 | Aera Router | Hanya localhost (melalui nginx) |
