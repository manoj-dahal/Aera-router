# Dokumentasi Server A2A Aera Router (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — Aera Router sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi Aera Router.
...
| :----------------- | :---------------------------------------------------------------------------------------------------------------------------------- |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas Aera Router. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan. |
