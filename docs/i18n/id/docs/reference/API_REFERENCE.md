...
Referensi lengkap untuk semua titik akhir API Aera Router.
...
| -------------------------- | ---------- | ------------------------------------------------ |
| `X-Aera-Router-No-Cache`   | Permintaan | Atur ke `true` untuk melewati cache              |
| `X-Aera-Router-Progress`   | Permintaan | Atur ke `true` untuk event progres               |
...
| `X-Aera-Router-Cache`      | Respons    | `HIT` atau `MISS` (non-streaming)                |
| `X-Aera-Router-Idempotent` | Respons    | `true` jika dideduplikasi                        |
| `X-Aera-Router-Progress`   | Respons    | `enabled` jika pelacakan progres aktif           |
| `X-Aera-Router-Session-Id` | Respons    | ID sesi efektif yang digunakan Aera Router       |
