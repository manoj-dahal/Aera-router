...
# Aera Router Documentation

Navigable index of the Aera Router documentation set. Topics are grouped by intent so you can find what you need quickly.
...
Simple guides for using Aera Router — no technical background needed.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — install and run Aera Router in 3 minutes.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — let Aera Router pick the best AI for you.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — first-time setup of Aera Router.
...
- [TIERS.md](guides/TIERS.md) — Aera Router tiers explained (user guide).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — running Aera Router under Docker.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — exposing Aera Router remotely + scoped tokens.
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — master table of `setup-*` CLI integrations.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI with Aera Router.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI with Aera Router.
...
- [AERA_ROUTER_VS_ALTERNATIVES.md](comparison/AERA_ROUTER_VS_ALTERNATIVES.md) — how Aera Router compares to alternatives.
