...
> Last updated: 2026-06-28 — Aera Router v3.8.40
>
...
├── @aera-router/           # Publishable companion packages (opencode-plugin, opencode-provider)
├── skills/               # CLI/agent skill packs (cli-* + omni-* + config-codex-cli)
├── examples/             # Sample plugins + aera-router-cmd-hello starter
...
Separate npm workspace (`@aera-router/open-sse`). Handles request processing + provider execution.
...
| `preload.js`     | IPC bridge (contextBridge → `window.aera-router`)                                 |
...
| File                                                                                                        | Purpose                                                                                                                              |
| ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `aera-router.mjs`                                                                                           | Main CLI entry — `aera-router serve`, `aera-router setup`, `aera-router doctor`, `aera-router providers`, `aera-router combos`, etc. |
...
| File                           | Purpose                                                                            |
| ------------------------------ | ---------------------------------------------------------------------------------- |
| `skills/aera-router*/SKILL.md` | 10 skill manifests for external AI agents (Claude Desktop, ChatGPT, Cursor, Cline) |
...
| `CLI-TOOLS.md`              | External CLI integrations + Internal Aera Router CLI                                  |
...
- **`_mono_repo/`** — historic subprojects (aeraRouterCloud, aeraRouterSite, vscode-extension)
