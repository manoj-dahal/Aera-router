---
title: "Aera Router Codebase Documentation"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Aera Router Codebase Documentation

> **Version:** v3.8.0
> **Last updated:** 2026-06-28
> **Audience:** Engineers contributing to Aera Router or building integrations on top of it.
>
...
directory is `DATA_DIR` env var, defaulting to `~/.aera-router/`.
...
├── open-sse/             Streaming engine workspace (@aera-router/open-sse)
├── electron/             Desktop wrapper (Electron 41 main + preload)
├── bin/                  CLI entry points (aera-router, reset-password)
...
| `responses.ts`, `aeraRouterResponseMeta.ts` | Response shape helpers                            |
...
Separate npm workspace published as `@aera-router/open-sse`. Owns request
...
```
bin/
├── aera-router.mjs           Main CLI entry (Node ESM)
...
- `aera-router` → `bin/aera-router.mjs`
- `aera-router-reset-password` → `bin/reset-password.mjs`
