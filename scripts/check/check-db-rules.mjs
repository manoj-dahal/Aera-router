...
// Estas rotas NÃO consultam o DB do Aera Router (getDbInstance) — elas abrem o
// SQLite de OUTRO aplicativo (Cursor / Kiro) para auto-importar credenciais.
// Por isso NÃO podem viver em src/lib/db/ (que é o domínio do DB do Aera Router):
...
// QUALQUER novo SQL cru contra o DB do Aera Router em rotas/handlers.
