/**
 * Shared policy for Aera Router npm publish artifact hygiene.
 *
...
export const APP_STAGING_ALLOWED_EXACT_PATHS: string[] = [
  ...
  // this bare entry the prepublish prune deleted it → every `aera-router` boot of the
  ...
  // this bare entry the prepublish prune (Step 10.7) deletes it → `aera-router serve`
...
export const PACK_ARTIFACT_ROOT_ALLOWED_EXACT_PATHS: string[] = [
  ...
  // Runtime polyfill eagerly imported by bin/aera-router.mjs (Node <22 compat);
...
export const PACK_ARTIFACT_REQUIRED_PATHS: string[] = [
  ...
  "bin/cli/program.mjs",
  // Direct imports of bin/aera-router.mjs — bin/cli/ is only an allowlist PREFIX, so a
  ...
  "bin/nodeRuntimeSupport.mjs",
  "bin/aera-router.mjs",
  // #7808: aliasResolver + its hook file. bin/aera-router.mjs imports
