...
/**
 * write-build-sha.mjs — HEAD sentinel guard for Aera Router release builds.
 *
 * Writes AERA_ROUTER_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.AERA_ROUTER_BUILD_SHA) {
    return process.env.AERA_ROUTER_BUILD_SHA.trim();
  }
  try {
