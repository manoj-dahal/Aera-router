...
/**
 * assembleStandalone.mjs - Shared standalone bundle assembler for Aera Router.
 *
 ...
 * CLI esbuild -> bin/aera-router.mjs                            -               Y           -    UNIQUE (prepublish)
...
const EXTRA_MODULE_ENTRIES = [
  ...
  },
  {
    ...
    // `aera-router --mcp` at startup. See #7701.
