 ...
 *
 * Reusable Phase-3 VPS HTTP client for Aera Router combo live-smoke tests.
 ...
 *   execFileSync("ssh", ["root@192.168.0.15", "sqlite3", "/root/.aera-router/storage.sqlite", SQL])
...
const VPS_DB_PATH = "/root/.aera-router/storage.sqlite";
...
if (isMain) {
  (async () => {
    console.log("=== Aera Router VPS Phase-3 Preflight ===");
