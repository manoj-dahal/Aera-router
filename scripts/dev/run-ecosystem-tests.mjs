...
const explicitBaseUrl = process.env.AERA_ROUTER_BASE_URL || "";
  ...
  const testEnv = {
    ...
    ...(explicitBaseUrl
      ...
      : {
          ...
          AERA_ROUTER_BASE_URL: baseUrl,
        }),
    AERA_ROUTER_E2E_BOOTSTRAP_MODE: process.env.AERA_ROUTER_E2E_BOOTSTRAP_MODE || "open",
