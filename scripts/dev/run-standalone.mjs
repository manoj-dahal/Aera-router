...
// #2939: honor AERA_ROUTER_MEMORY_MB (default 512), the same knob
// `aera-router serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.AERA_ROUTER_MEMORY_MB);
