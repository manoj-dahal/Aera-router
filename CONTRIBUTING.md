...
> **VPS deploy note:** the remote image directory `/usr/lib/node_modules/aera-router/app/`
...
open-sse/                   # @aera-router/open-sse workspace
...
├── comparison/              # Aera Router vs alternatives
