 ...
 * `providerId` field — Aera Router's `normalizeComboRecord` folds the provider
...
import { isUsableCombo, type AeraRouterRawCombo } from "../src/index.js";
...
function combo(models: AeraRouterRawCombo["models"]): AeraRouterRawCombo {
